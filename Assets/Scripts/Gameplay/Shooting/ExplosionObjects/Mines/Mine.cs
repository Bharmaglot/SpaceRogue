...
namespace SpaceRogue.Gameplay.Shooting
{
    public sealed class Mine : IDisposable
    {
        ...
        private readonly DamageExplosionView _mineExplosionView;
        ...
        public Mine(Updater updater, MineView mineView, TimerFactory timerFactory, MineConfig mineConfig, IDestroyable destroyable)
        {
            ...
            _mineAlertZoneTransform = mineView.AlertZoneTransform;
            _mineTimerVisualTransform = mineView.TimerVisualTransform;
            ...
            _dangerRadius = _mineAlertZoneTransform.localScale.x;

            _targetUnitType = mineConfig.TargetUnitType;

            _mineAlertZoneView = mineView.MineAlertZoneView;
            _mineExplosionView = mineView.DamageExplosionView;
        ...
        {
            if (_mineTimerVisualTransform.localScale.x < _dangerRadius)
            {
